...
& $signtool sign /s my /n "vdev Virtual Display Driver" /fd sha256 /q (Join-Path $dist "vdev_hid.sys")
...
& $signtool sign /s my /n "vdev Virtual Display Driver" /fd sha256 /q (Join-Path $dist "vdev-hid.cat")
