...
@interface VDObjectStore ()
@property NSMutableDictionary *objectMap;
@end

@implementation VDObjectStore
...
+ (VDObjectStore *)SharedObjectStore {
    static VDObjectStore *sObjectStore = nil;
...
+ (NSObject<CMIOObject> *)GetObjectWithId:(CMIOObjectID)objectId {
    return [[VDObjectStore SharedObjectStore] getObject:objectId];
}
